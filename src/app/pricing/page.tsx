            ...
            <main>
                <section className="border-b border-border/70 bg-[radial-gradient(circle_at_top_left,rgba(205,223,255,0.48),transparent_34%),linear-gradient(180deg,rgba(253,253,255,0.98),rgba(247,250,255,0.95))]">
                    <div className="mx-auto max-w-7xl px-6 py-18 lg:py-22">
                        ...
                        <Badge
                            variant="outline"
                            className="mt-6 bg-primary/6 text-primary"
                        >
                            Pricing and packages
                        </Badge>
                        <h1 className="mt-5 max-w-4xl font-display text-5xl text-foreground sm:text-6xl">
                            Choose the package that fits your academic rollout.
                        </h1>
                        <p className="mt-5 max-w-3xl text-lg leading-8 text-muted-foreground">
                            Built to support both self-serve interest and
                            institution-led buying. The pricing structure stays
                            simple enough for a fast evaluation while still
                            leaving room for faculty or enterprise rollout
                            conversations.
                        </p>
                    </div>
                </section>
                            ...
                            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                                <div>
                                    ...
                                    <p className="mt-2 text-sm leading-7 text-muted-foreground">
                                        ...
                                        because it unlocks collaboration and
                                        richer coursework operations without
                                        jumping all the way to full exam
                                        workflows.
                                    </p>
                                </div>
                                <Badge
                        ...
                        <div className="grid gap-5 xl:grid-cols-3">
                            {plans.map((plan) => (
                                ...
                                >
                                    ...
                                    <div
                                        className={`mt-1 text-sm ${plan.featured ? "text-primary-foreground/76" : "text-muted-foreground"}`}
                                    >
                                        {plan.cadence}
                                    </div>
                                    <p
                                        className={`mt-4 text-sm leading-7 ${plan.featured ? "text-primary-foreground/82" : "text-muted-foreground"}`}
                                    >
                                        {plan.summary}
                                    </p>
                                    <ul className="mt-6 space-y-3">
                                        {plan.features.map((feature) => (
                                            <li
                                                key={feature}
                                                className={`flex items-start gap-3 text-sm ${plan.featured ? "text-primary-foreground/84" : "text-muted-foreground"}`}
                                            >
                                                <Check
                                    ...
                                    <Button
                                        ...
                                        className={`mt-8 w-full rounded-full ${plan.featured ? "border-white/20 bg-white/12 text-primary-foreground hover:bg-white/18" : ""}`}
                                    >
                    ...
                    <div className="mx-auto max-w-7xl px-6">
                        <div className="max-w-3xl">
                            ...
                            <h2 className="mt-4 font-display text-4xl text-foreground">
                                The differences are visible in under a minute.
                            </h2>
                            <p className="mt-4 text-lg leading-8 text-muted-foreground">
                                This comparison keeps the focus on scale, exams,
                                collaboration, governance, and support instead
                                of drowning buyers in tiny feature-checkbox
                                noise.
                            </p>
                        </div>
                                        ...
                                        {comparisonRows.map((row) => (
                                            ...
                                            >
                                                {row.map((cell, index) => (
                                                    <td
                                                        key={`${row[0]}-${index}`}
                                                        className={`px-5 py-4 ${index === 0 ? "font-medium text-foreground" : "text-muted-foreground"}`}
                                                    >
                                                        {cell}
                                                    </td>
                                                ))}
                        ...
                        <div className="mt-6 rounded-[24px] border border-border/70 bg-background px-5 py-4 text-sm text-muted-foreground shadow-sm">
                            Use this comparison to choose between pilot usage,
                            collaboration, and full exam-enabled operations.
                        </div>
                    </div>
                </section>
                <section className="py-18">
                    <div className="mx-auto max-w-7xl px-6">
                        <div className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
                            <div className="rounded-[30px] border border-border/70 bg-card px-6 py-7 shadow-sm">
                                ...
                                <h2 className="mt-4 font-display text-4xl text-foreground">
                                    A simple self-serve path from pilot to Pro.
                                </h2>
                                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                                    <div className="rounded-[24px] border border-border/70 bg-background px-4 py-4">
                                        ...
                                        <p className="mt-2 text-sm leading-7 text-muted-foreground">
                                            Best for pilots, evaluation, and a
                                            first live classroom rollout with
                                            tight usage limits.
                                        </p>
                                    </div>
                                    <div className="rounded-[24px] border border-border/70 bg-background px-4 py-4">
                                        ...
                                        <p className="mt-2 text-sm leading-7 text-muted-foreground">
                                            Upgrade to Plus for collaboration
                                            and Pro for full exam operations and
                                            premium controls.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="rounded-[30px] border border-border/70 bg-card px-6 py-7 shadow-sm">
                                ...
                                <p className="mt-4 text-sm leading-7 text-muted-foreground">
                                    Start with Free, move to Plus when
                                    collaboration becomes real, and upgrade to
                                    Pro when exams or premium controls become
                                    core.
                                </p>
